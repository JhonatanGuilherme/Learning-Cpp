...
int main() {
  /*
  Container Vector - é um container sequencial;
  No caso do vector, os elementos são armazenados ordenadamente
  na memória, logo são acessados por índices facilmente.
  Obs: Funciona como um array;
  */
